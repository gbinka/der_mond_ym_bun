...
preload: function(){
	...
	//game.load.spritesheet('pomagacze', 'assets/pomagacze/pomagacze_big.png',65,80);
	...
	game.load.tilemap('mapa', 'assets/tilemaps/part_marged.json', null, Phaser.Tilemap.TILED_JSON);
